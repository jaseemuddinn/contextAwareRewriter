                ...
                <div className="max-w-md w-full space-y-8">
                    <div>
                        ...
                        <p className="mt-2 text-center text-sm text-gray-600 dark:text-gray-400">
                            Access your rewrite history and sync your preferences
                        </p>
                    </div>
                                    ...
                                    {loading ? (
                                        <div className="flex items-center justify-center">
                                            <div className="relative mr-3">
                                                ...
                                                <div className="animate-spin rounded-full h-4 w-4 border-2 border-transparent border-t-white absolute top-0"></div>
                                            </div>
                                            Signing in...
                                        </div>
                                    ) : (
